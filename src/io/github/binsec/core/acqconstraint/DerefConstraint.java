...
public class DerefConstraint extends BinaryConstraint {
	...
	public DerefConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2) {
		super("Deref", cell1.getValue().id, cell2.isGlobal() ? cell2.getRef().id : -1);
		
		this.cell1 = cell1;
		this.cell2 = cell2;
		
		ACQ_Variable v1 = cell1.getValue();
		ACQ_Variable v2 = cell2.getRef();
		if (v1.getType() != CellType.PTR || !cell2.isGlobal()) {
	...
	public DerefConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2, boolean negated) {
		this(cell1, cell2);
		if (negated) {
			this.setName("NotDeref");
	...
	public ACQ_IConstraint getNegation() {
		return new DerefConstraint(this.cell1, this.cell2, !this.negated);
	}
	...
	public String toSmtlib() {
		String d = "(deref v" + this.cell1.cellid + " v" + this.cell2.cellid + ")";
		if (!negated) return d;
		else return "(not " + d + ")";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DerefConstraint other = (DerefConstraint) obj;
