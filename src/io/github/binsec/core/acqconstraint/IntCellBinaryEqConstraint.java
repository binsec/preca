...
public class IntCellBinaryEqConstraint extends BinaryConstraint {
	boolean negated = false;
	ACQ_CellVariable cell1;
	ACQ_CellVariable cell2;
	ACQ_Variable[] vars; // length = 2
	
	public IntCellBinaryEqConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2) { 
		super("Eq", cell1.getValue().id, cell2.getValue().id); // TODO : WARNING I don't know if it is good
	...
	public IntCellBinaryEqConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2, boolean negated) {
		this(cell1, cell2);
		if (negated) {
			this.setName("Neq");
	...
	public ACQ_IConstraint getNegation() {
		return new IntCellBinaryEqConstraint(this.cell1, this.cell2, !this.negated);
	}
	...
	public String toSmtlib() {
		String e = "(eq v" + this.cell1.cellid + " v" + this.cell2.cellid  +  ")";
		if (!negated) return e;
		else return "(not " + e + ")";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IntCellBinaryEqConstraint other = (IntCellBinaryEqConstraint) obj;
