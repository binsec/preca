...
public class PtrCellBinaryLTConstraint extends BinaryConstraint {
	boolean negated = false;
	ACQ_CellVariable cell1;
	ACQ_CellVariable cell2;
	ACQ_Variable[] vars; // length = 2
	
	public PtrCellBinaryLTConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2) { 
		super("PtrLT", cell1.getValue().id, cell2.getValue().id); // TODO : WARNING I don't know if it is good
	...
	public PtrCellBinaryLTConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2, boolean negated) {
		this(cell1, cell2);
		if (negated) {
			this.setName("PtrGE");
	...
	public ACQ_IConstraint getNegation() {
		return new PtrCellBinaryLTConstraint(this.cell1, this.cell2, !this.negated);
	}
	...
	public String toSmtlib() {
		String p = "(ptrlt v" + this.cell1.cellid + " v" + this.cell2.cellid + ")";
		if (!negated) return p;
		else return "(not " + p + ")";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PtrCellBinaryLTConstraint other = (PtrCellBinaryLTConstraint) obj;
